...
class PaymentServiceImplAdditionalTest {
    ...
    @Test
    void processPayment_debit_missingCardLastFour_throws() {
        PaymentRequest request = PaymentRequest.builder()
                .merchantId(1L)
                .amount(new BigDecimal("50.00"))
                .currency("USD")
    ...
    @Test
    void processPayment_debit_invalidCardLastFour_throws() {
        PaymentRequest request = PaymentRequest.builder()
                .merchantId(1L)
                .amount(new BigDecimal("50.00"))
                .currency("USD")
    ...
    @Test
    void processPayment_exceedsMerchantDailyLimit_throws() {
    ...
    @Test
    void processPayment_merchantNullDailyLimit_skipsCheck() {
    ...
    void getPaymentByTransactionId_found() {
        Payment payment = Payment.builder()
                ...
                .paymentType(PaymentType.CREDIT_CARD)
                .build();
        when(paymentRepository.findByTransactionId("TXN-XYZ")).thenReturn(Optional.of(payment));

        PaymentResponse response = paymentService.getPaymentByTransactionId("TXN-XYZ");
        assertEquals("TXN-XYZ", response.getTransactionId());
    }
    ...
    void getPaymentsByMerchant_returnsList() {
        List<Payment> payments = List.of(
                ...
                Payment.builder().id(2L).transactionId("TXN-2").merchantId(1L)
                        ...
                        .status(PaymentStatus.COMPLETED).paymentType(PaymentType.WIRE).build()
        );
    ...
    @Test
    void updatePaymentStatus_fromTerminal_throwsException() {
        Payment payment = Payment.builder()
                .id(1L)
                .transactionId("TXN-123")
                .status(PaymentStatus.COMPLETED)
    ...
    @Test
    void updatePaymentStatus_fromTerminalToRefunded_succeeds() {
        Payment payment = Payment.builder()
                .id(1L)
                .transactionId("TXN-123")
                .merchantId(1L)
    ...
    @Test
    void processPayment_creditCard_invalidCardLastFour_throws() {
        PaymentRequest request = PaymentRequest.builder()
                .merchantId(1L)
                .amount(new BigDecimal("50.00"))
                .currency("USD")
    ...
    // --- Idempotency with null/empty key ---

    @Test
    void processPayment_nullIdempotencyKey_proceedsNormally() {
        PaymentRequest request = PaymentRequest.builder()
                .merchantId(1L)
                .amount(new BigDecimal("99.99"))
                .currency("USD")
    ...
    @Test
    void processPayment_emptyIdempotencyKey_proceedsNormally() {
        PaymentRequest request = PaymentRequest.builder()
                .merchantId(1L)
                .amount(new BigDecimal("99.99"))
                .currency("USD")
