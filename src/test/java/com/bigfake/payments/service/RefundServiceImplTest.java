...
class RefundServiceImplTest {
    ...
    void processRefund_success() {
        ...
        assertEquals("agent-007", refund.getInitiatedBy());
    ...
    void getRefundsForPayment_returnsList() {
        Refund refund = Refund.builder().id(5L).paymentId(1L).build();
        when(refundRepository.findByPaymentId(1L)).thenReturn(List.of(refund));

        assertEquals(List.of(refund), refundService.getRefundsForPayment(1L));
    }
}
