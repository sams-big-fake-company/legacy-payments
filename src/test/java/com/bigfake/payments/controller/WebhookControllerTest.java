...
class WebhookControllerTest {
    ...
    @Test
    void handlePaymentStatusWebhook_withSignature_returnsAccepted() throws Exception {
        PaymentResponse response = PaymentResponse.builder()
                .id(1L)
                .transactionId("TXN-123")
                .status(PaymentStatus.COMPLETED)
    ...
    @Test
    void handlePaymentStatusWebhook_serviceThrows_returns200WithWarning() throws Exception {
    ...
    @Test
    void handlePaymentStatusWebhook_pendingStatus_mapsToProcessing() throws Exception {
        PaymentResponse response = PaymentResponse.builder()
                .id(1L)
                .transactionId("TXN-123")
